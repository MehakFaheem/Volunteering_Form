...
dsn = cx_Oracle.makedsn('localhost', '1522', service_name='xepdb1')  # Adjust host, port, and service_name
connection = cx_Oracle.connect(user='volunteer_form', password='volunteer_form', dsn=dsn)
